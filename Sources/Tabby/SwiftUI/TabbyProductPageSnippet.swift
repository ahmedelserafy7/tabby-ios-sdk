...
public struct TabbyProductPageSnippet: View {
  ...
  public var body: some View {
    ...
    print("\(Lang), \(isRTL)")
    let textNode1 = kind == .common ? String(format: preferCurrencyInArabic ? "snippetArTitle1".localized : "snippetTitle1".localized) : String(format: "snippetTitle1EG".localized)
